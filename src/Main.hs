...
t = makeTriangle (Vector3 (3.0, -4.0, -1.0)) (Vector3 (-3.0, -4.0, -1.0)) (Vector3 (0.0, -4.0, 6.0)) (Material 0.3 0.0 0.2 0.4 (Color (0.3, 1.0, 0.3))) 
p = Plane (Vector3 (0.0, 0.0, 10.0)) (Vector3 (0.0, 0.0, -1.0)) (Material 0.4 0.0 0.5 0.0 (Color (1.0, 1.0, 1.0))) 
...
scene = Scene [Object s1, Object s2, Object s3, Object t, Object p] l (Color (0.1, 0.1, 0.1))
